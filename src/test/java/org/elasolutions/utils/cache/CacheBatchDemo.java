...
public class CacheBatchDemo implements SimpleCacheCallback<String, String> {
    ...
    private void run() {
        ...
        m_batchProcessing = new SimpleCache<String, String>("CateghroyName", 10000, this, 5000);
    ...
    class TestThread extends Thread {
        ...
        public void run() {
            ...
            System.out.println("\rnLast element called at: " + (System.currentTimeMillis() - m_start));
    ...
    public void removedElement(Element<String,String> element) {
        System.out.println("Removed at: " + (System.currentTimeMillis() - m_start));
