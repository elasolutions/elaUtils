...
public class PerformanceMultiActionDemo {

    public static void main(final String[] args) {
        System.out.println("Start: PerformanceMultiActionDemo");
        System.out.println("---------------------------------------------");

        final long start = System.currentTimeMillis();

        final PerformanceMultiActionDemo test = new PerformanceMultiActionDemo();
        test.run();
    ...
    private void run() {
        ...
        tester.run(actions, new TestExecutionListener() {
            @Override
        ...
        TestResults results2 = tester.getResults();
